...
const CandidateList = () => {
    ...
    if (scoreFilter !== "all") {
      filtered = filtered.filter((candidate) => {
        ...
        if (scoreFilter === "medium")
          return candidate.ats_score >= 60 && candidate.ats_score < 80;
  ...
  const updateCandidateStatus = async (
    ...
    toast("Candidate status updated successfully.");
  };
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-4 mb-2">
                    ...
                    {candidate.ats_score !== null &&
                      candidate.ats_score !== undefined && (
                        <Badge
                          className={getScoreBadgeColor(candidate.ats_score)}
                        >
                  ...
                  {candidate.job_descriptions && (
                    <p className="text-sm text-gray-600">
                      Applied for: {candidate.job_descriptions.title} -{" "}
                      {candidate.job_descriptions.department}
                    </p>
                  )}
